...
the title, no the fleet scaffolding repo leak, no sibling-relative script commands.
...
the fleet scaffolding repo-leak check, and the sibling-relative-path check stay universal.
