 ...
 *
 * Usage:
 * node scripts/repo/helpers/socket-setup.mjs <subcommand> [options]
 *
      ...
      default:
        process.stderr.write(
          JSON.stringify({
            ...
            usage:
              'node scripts/repo/helpers/socket-setup.mjs <check-prereqs|generate-config|detect-dockerfiles> [options]',
          }) + '\n',
        )
        process.exit(1)
    }
