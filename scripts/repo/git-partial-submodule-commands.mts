/**
 * @file The 4 subcommand implementations for `git-partial-submodule.mts`:
 *   add / clone / save-sparse / restore-sparse. Split out of the CLI entry to
 *   keep each file under the 500-line soft cap.
 */
