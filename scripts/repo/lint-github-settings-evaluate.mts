...
export function evaluate(
  ...
  // Local shadows of shared workflows: a finding wants EITHER the local
  // file gone in favor of `uses:`-ing the shared workflow, OR an explicit
  // opt-out header `# socket-bypass: workflow-shadow -- <reason>` on the
  // local file documenting why it's intentional.
