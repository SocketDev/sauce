...
- 🚨 No commit trailer or branch name carries an AI tool's mark; the gate scans all reachable history, not just new commits. (`scripts/fleet/check/commits-carry-no-ai-attribution.mts`) [`agent-detection-surfaces`](docs/agents.md/fleet/agent-detection-surfaces.md)
